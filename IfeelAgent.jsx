...
const SP_PARTS = [
  ...
  "SOURCE 1 - IFEEL BLOG GAPS (EXPANDED): web_search 'site:ifeelonline.com blog', 'site:ifeelonline.com/es blog', 'site:ifeelonline.com/resources', 'site:ifeelonline.com/ebooks', 'site:ifeelonline.com/case-studies', 'site:ifeelonline.com/es/recursos'. Map existing topics, identify gaps, extract URLs. CRITICAL: Include all gated content, research reports, case studies, and ebooks - these represent ifeel's thought leadership and must not be duplicated.",
