...
const SP_PARTS = [
  ...
  "11. UNIFIED CONCLUSION + CTA (100-150 words): Forward-looking, encouraging. Links to ifeelonline.com. IMPORTANT: This article is PUBLISHED ON ifeel's blog. Do NOT add 'visit ifeelonline.com to learn more' - instead use direct CTAs like 'Get in touch with our team' or 'Discover how ifeel's approach works'. Remove any phrases suggesting readers should visit ifeel elsewhere.",
  "12. DO NOT include a separate 'Leadership lens closing' - incorporate leadership perspective into conclusion. One unified closing, not two.",
  ...
  "STEP 4 - ES DRAFT: Write the COMPLETE Spanish article (all 12 sections + frontmatter + SEO table + internal link proposals + external link proposals). End with: 'Spanish draft complete. Please review both drafts and approve links separately (EN and ES links may differ).'",
